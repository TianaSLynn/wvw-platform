...
export const CLIENT_ONBOARDING_STEPS: OnboardingStepTemplate[] = [
  { sortOrder: 1, category: "GENERAL", title: "Confirm client account and primary contact",
    description: "Verify the organization profile, executive sponsor, primary contact, and designated technical support contact." },
  { sortOrder: 2, category: "GENERAL", title: "Complete organizational profile and audit objectives",
    description: "Capture workforce profile, locations, operating context, primary concerns, decision questions, and desired outcomes.",
    blockedBySortOrder: 1 },
  { sortOrder: 3, category: "LEGAL", title: "Approve confidentiality, consent, and data-handling plan",
    description: "Confirm agreements, confidentiality language, retention rules, anonymity threshold, and who may view released results.",
    blockedBySortOrder: 2, documentRequired: true, documentLabel: "Approved confidentiality and data-handling plan" },
  { sortOrder: 4, category: "GENERAL", title: "Define participant groups and invitation plan",
    description: "Confirm leadership, workforce, governance, recipient, and other participant groups; identify exclusions and accessibility needs.",
    blockedBySortOrder: 3 },
  { sortOrder: 5, category: "GENERAL", title: "Review evidence readiness",
    description: "Identify available policies, workforce data, prior surveys, organizational charts, and operational evidence needed to verify perceptions.",
    blockedBySortOrder: 4, documentRequired: true, documentLabel: "Evidence inventory / organizational chart" },
  { sortOrder: 6, category: "IT", title: "Activate and test the secure client portal",
    description: "Confirm the client can sign in, view only their engagement, complete onboarding, and reach WVW support.",
    blockedBySortOrder: 5 },
  { sortOrder: 7, category: "GENERAL", title: "Conduct audit launch meeting",
    description: "Review the audit purpose, participant communications, evidence requests, timeline, support process, and decision gates.",
    blockedBySortOrder: 6, documentRequired: true, documentLabel: "Approved launch plan" },
  { sortOrder: 8, category: "GENERAL", title: "Configure Organizational Initial Audit",
    description: "Review the automatically assigned diagnostic, confirm question set, anonymity threshold, dates, audiences, and collection status.",
    blockedBySortOrder: 7 },
  { sortOrder: 9, category: "IT", title: "Test invitation and participant journey",
    description: "Use synthetic participants to verify unique invitations, consent, save/submit behavior, accessibility, and support escalation.",
    blockedBySortOrder: 8 },
  { sortOrder: 10, category: "GENERAL", title: "Open audit collection",
    description: "Toggle collection on only after the protection gates pass, then release invitations and the client communication packet.",
    blockedBySortOrder: 9 },
  { sortOrder: 11, category: "IT", title: "Monitor participation and provide client support",
    description: "Track completion without exposing identities; resend links, add approved participants, and document technical assistance from Intelligence.",
    blockedBySortOrder: 10 },
  { sortOrder: 12, category: "GENERAL", title: "Complete evidence verification",
    description: "Compare threshold-released participant themes with policies, records, interviews, and operational evidence.",
    blockedBySortOrder: 11 },
  { sortOrder: 13, category: "GENERAL", title: "Review findings and consulting priorities",
    description: "Validate main concerns, strengths, evidence gaps, recommended specialty audits, and the proposed 30/60/90-day response.",
    blockedBySortOrder: 12 },
  { sortOrder: 14, category: "GENERAL", title: "Approve results release and next-step roadmap",
    description: "Complete WVW quality review, release the approved client briefing, and convert findings into the consulting engagement roadmap.",
